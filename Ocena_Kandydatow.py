...
Tworzy plik Ocena_Kandydatow.xlsx z dwoma arkuszami:
1. Ocena kandydatów - formularz z automatycznymi obliczeniami
2. Pytania rekrutacyjne - gotowe pytania do kandydatów
"""
...
def create_excel_file():
    ...
    print(f"✓ Data utworzenia: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
